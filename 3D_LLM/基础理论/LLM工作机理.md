...
参数量=64000⋅4096=262,144,000 （约2.62亿参数）\text{参数量} = 64000 \cdot 4096 = 262,144,000 \, \text{（约2.62亿参数）}参数量=64000⋅4096=262,144,000（约2.62亿参数）
...
参数量=202,383,360⋅32=6,476,267,520 （约64.76亿参数）\text{参数量} = 202,383,360 \cdot 32 = 6,476,267,520 \, \text{（约64.76亿参数）}参数量=202,383,360⋅32=6,476,267,520（约64.76亿参数）
